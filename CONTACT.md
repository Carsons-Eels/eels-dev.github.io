...
- _github_: [@marioevz](https://github.com/marioevz)
- _email_: mario (dot) vegazavala (at) ethereum (dot) org

### EEST Team Developers
...
- _twitter_: [@danceratopz](https://x.com/danceratopz)
- _telegram_: @danceratopz
...
- _twitter_: [@techbro_ccoli](https://x.com/techbro_ccoli)
...
- _github_: []()
- _email_: felipe (dot) (at) ethereum (dot) org
...
- _email_: leo (dot) lara (at) ethereum (dot) org
- _twitter_: [@leolarav](https://x.com/leolarav)
...
- _email_: louis (dot) tsai-csie (at) ethereum (dot) org
- _twitter_: [@0xlouistsai](https://x.com/0xlouistsai)
